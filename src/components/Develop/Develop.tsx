...
/*                       <div
                            className={`w-[400px] aspect-video border-solid border-2 border-white bg-[#000000] flex justify-center items-center font-bold text-[32px] text-[#ffffff]`}>Пример
                            проекта
                        </div>
                        <div
                            className={`w-[400px] aspect-video border-solid border-2 border-white bg-[#000000] flex justify-center items-center font-bold text-[32px] text-[#ffffff]`}>Пример
            ...
            <AnimatePresence>
                {show && (
                    <motion.aside
                        ...
                        <h2 className={`font-semibold text-[40px] text-[#ffffff]`}>Разработка</h2>
