            ...
            <AnimatePresence>
                {show && (
                    <motion.aside
                        ...
                        <h2 className={`font-semibold text-[30px] text-[#ffffff]`}>Развитие существующего бизнеса</h2>
                        <p className={`font-medium text-[18px] w-[100%] text-start text-[#ffffff]`}>
                            - Разработка стратегии развития: Формируем долгосрочную стратегию, которая поможет вашему бизнесу расти и адаптироваться к изменениям на рынке.
                            - Обновление дизайна и промо: Перерабатываем существующие материалы, улучшая их эффективность и соответствие современным требованиям.</p>
                        <button
